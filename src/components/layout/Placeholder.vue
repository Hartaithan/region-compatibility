...
<template>
  <div
    class="relative overflow-hidden rounded border border-dashed border-gray-500 opacity-75 px-4 flex items-center justify-center"
    :class="classes"
  >
    <svg class="absolute inset-0 h-full w-full stroke-white/10" fill="none">
      <defs>
        <pattern
